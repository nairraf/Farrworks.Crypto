        ...
        public static IEnumerable TestCases
        {
            get
            {
                ...
                yield return new TestCaseData(@"
                                        ...
                                        0123456789");
                yield return new TestCaseData("哦吉艾娜艾娜诶哦伊娜哦");
                yield return new TestCaseData("㊗㊊㊋㊖㊋㊖㊃㊗㊇㊖㊗1234567890");
                yield return new TestCaseData("ｻｪｺｻｮｴｬ ｳｶｹｪ ｻｭｮｴｬｺ, ｲｮｱｪ ｯｦｷｦｴｪｺｪ ｴｶｾ");
                yield return new TestCaseData("šомё мояє fци шїтн циїcdё");
            }
        }
    }
}
